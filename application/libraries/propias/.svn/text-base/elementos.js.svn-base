	...
	//alert(parametros.expreg);
             ...
             for(var i =0; i< parametros.tipos.length; i+=parametros.columnas){	
                    if((parametros.tipos.length - i)/parametros.columnas >= 1)
			 		...
			 		PasarParciales(parametros, parametrosFila, Array('tipos', 'names', 'ids', 'hijos', 'colspan', 'expreg'), i , i+parametros.columnas);
...
//	   alert(parametros.expreg);
		   ...
		   for(var i =0; i< parametros.cantColumnas; i++){	
			 		PasarParciales(parametros, parametrosColumna, Array('tipos', 'names', 'ids', 'hijos', 'colspan', 'expreg'), i , i+1);
	    ...
	    if(parametros.tipos == 'tabla'){
			...
			this.crearTabla(parametros.hijos[0]);
		       ...
		       if(this.labels){			   	   
				...
				var elemento = this.crearElemento(parametros.tipos[0], parametros.ids[0], parametros.names[0], parametros.expreg[0]);
...
//Retorno: el elemento creado
    crearElemento : function(tipo, id, name, expreg, atributos){
		if(tipo<2)
			var elemento = this.crearText(tipo, id, name, expreg);
		else if(tipo < 3)
...
//Parametros: 
	...
	//name: su name
//Retorno: la caja de texto
	crearText : function(tipo, id, name, expreg, atributos){
		switch(tipo){
